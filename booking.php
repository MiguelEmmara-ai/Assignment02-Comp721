                ...
                <div class="col-lg-7">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" style="margin-top: 70px;max-width: 1000px;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="unumber" name="unumber" placeholder="🏡 143" required="" class="form-control <?php echo (!empty($unitNumber_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $unitNumber; ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="sbname" name="sbname" placeholder="🏙️ Auckland CBD" required="" class="form-control <?php echo (!empty($suburb_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $suburb; ?>">
                            <span class="invalid-feedback"><?php echo $suburb_err; ?></span>
                        </div>
                        <div class="mb-3">
                            <p><strong>Destination Suburb</strong><br></p>
                            <input type="text" id="dsbname" name="dsbname" placeholder="🏙️ Manukau" required="" class="form-control <?php echo (!empty($destinationSuburb_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $destinationSuburb; ?>">
